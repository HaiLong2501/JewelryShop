<%-- 
    Document   : ListProductLine
    Created on : Mar 17, 2025, 9:23:46 PM
    Author     : Hai Long
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="model.ProductLine, java.util.Vector, java.text.DecimalFormat" %>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    <div class="btn-group">
                        <div class="search">
                            <form class="form-horizontal" role="form" action="productline" method="get">
                        ...
                        <div class="insert-btn">
                            ...
                            <!-- The modal -->
                            <form action="productline" method="get">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="modalLabel">Product Line Info</h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="modal-container">
                                                    <div class="modal-h"><h5>Product Line's ID</h5></div>
                                                    <div class="modal-con">
                                                        <input type="text" name="productLineID" value="">
                                                    </div>
                                                </div>
                                                <div class="modal-container">
                                                    <div class="modal-h"><h5>Product Line's Name</h5></div>
                                                    <div class="modal-con">
                                                        <input type="text" name="productLineName" value="">
                                                    </div>
                                                </div>
                                                <div class="modal-container">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="service" value="insertProductLine" class="btn btn-change">Insert</button>
                    ...
                    <div class="contentPro">
                        <table>
                            ...
                            <tbody class="card-content">
                                <% for(ProductLine l: listProdLine) { %>
                                <tr>
                                    <td><%= l.getProductLineID()%></td>
                                    <td><%= l.getProductLineName()%></td>
                                    <td style="width: 150px;height: 150px;"><img style="width: 150px;height: 150px;" src="<%= request.getContextPath() %>/images/productLines/<%= l.getImage()%>" alt="<%= l.getProductLineName()%>"/></td>
                                    <td style="text-align: center;">
                                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#flipFlop_<%= l.getProductLineID()%>">
                                            Detail
                                        </button>

                                        <!-- The modal -->
                                        <form action="productline" method="get">
                                            <div class="modal fade" id="flipFlop_<%= l.getProductLineID()%>" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-container">
                                                                <div class="modal-h"><h5>Description</h5></div>
                                                                <div class="modal-con">
                                                                    <input type="text" name="description" value="<%= l.getDescribe() %>" >
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="hidden" name="plId" value="<%= l.getProductLineID()%>">
                                                                <button type="submit" name="service" value="updateProductLine" class="btn btn-change">Update</button>
                                                                <button type="submit" name="service" value="deleteProductLine" onclick="return confirm('Do you sure to delete this Category?')" class="btn btn-change">Delete</button>
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                    </form>
